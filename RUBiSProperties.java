 ...
 * Changes: Introduced two private members IP and SLAThreshold
 * Parsing logic to read from the config and update the private members
 * Methods to get the IP and SLAThreshold values
 */
...
public class RUBiSProperties
{
  ...
  private String  IP;//Notification Server IP
  private long    SLAThreshold;//SLA Response Time Threshold
  ...
  public URLGenerator checkPropertiesFileAndGetURLGenerator()
  {
    try
    {
      ...
      SLAThreshold = Long.valueOf(getProperty("SLA_Response_Time"));
      IP = getProperty("SLA_violate_notify_IP");
  ...
  /**
   * Get the SLA Response Time threshold value configured
   */
  public long getSLAThreshold()
  {
    return SLAThreshold;
  }

  /**
   * Get the notification server IP
   */
  public String getIP()
  {
    return IP;
